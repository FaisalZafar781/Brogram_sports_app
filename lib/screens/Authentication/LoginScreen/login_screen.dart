                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment
                        .spaceBetween, // Aligns the row to the right
                    children: [
                      Checkbox(
                        value:
                            _isChecked, // Assuming _isChecked is a boolean variable for checkbox state
                      ...
                      SizedBox(
                          width:
                              20), // Add some space between the text and the "Forgot Password" button
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                              context,
